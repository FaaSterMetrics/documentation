...
As we defined in section~\Cref{sec:WorkloadsStructure} we are using artillery to run workloads on experiments. 
...
Please reference Figure~\Cref{fig:exampleWorkloadYML} for a full example of a minimal \texttt{workload.yml}.
