...
\begin{tcolorbox}
  \mintinline{yaml}{'\{\{ \$processEnvironment.PROCESSOR\_DIR\}\}/logger.js'} 
\end{tcolorbox}
...
\end{minted}
\end{tcolorbox}
In this example, \mintinline{yaml}{'{{ functioname }}'} will automatically resolve to endpoint of the function \texttt{functionname}. \\
