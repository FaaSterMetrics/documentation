...
In this section, the build and deployment and finally destruction process of an experiment is explained. Please ensure that your `experiment.json` file is configured correctly (TODO: cref). All required providers need to be set up correctly (\Cref{sec:providersetup}).
...
% missing: destroy, (logs, analysis) (probably in analysis description?)
