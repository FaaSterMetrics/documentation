...
We are using standard artillery workload-definitions so the \texttt{official documentation}\footnote{\url{https://artillery.io/docs/}} apply. However there are some requirements that need to be fullfilled, please see Figure~\Cref{fig:exampleWorkloadYML} for an example of a valid FaaSterMetrics workload.yml.
